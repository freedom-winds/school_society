...
class ClubRevision(Base):
    ...
    name: Mapped[str] = mapped_column(String(30), default="", nullable=False)
    category_id: Mapped[int | None] = mapped_column(ForeignKey("club_categories.id"), index=True)
    short_intro: Mapped[str] = mapped_column(String(100), default="", nullable=False)
    recruitment_slogan: Mapped[str] = mapped_column(String(80), default="", nullable=False)
